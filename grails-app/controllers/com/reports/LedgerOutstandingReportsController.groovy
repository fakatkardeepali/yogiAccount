...
@ParentScreen(name = "Outstanding", fullName = "Ledger Outstanding", sortList = 1, link = "/reports/ledgerOutstanding")
class LedgerOutstandingReportsController {
    def jasperService
    MasterReportService masterReportService

    def index() {}

    def ledgerOutstandingReport() {
        def reportDetails = [];
        def data = [];
