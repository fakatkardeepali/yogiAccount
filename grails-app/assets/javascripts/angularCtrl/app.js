(function () {
    ...
    angular.module("app.chart.ctrls", []).controller("chartCtrl", ["$scope", function ($scope) {
        ...
        return lineChart1 = {}, lineChart1.data1 = [
        ...
        ], $scope.area.options = {series: {lines: {show: !0, fill: !1}, points: {show: !0, lineWidth: 2, fill: !0, fillColor: "#ffffff", symbol: "circle", radius: 5}, shadowSize: 0}, grid: {hoverable: !0, clickable: !0, tickColor: "#f9f9f9", borderWidth: 1, borderColor: "#eeeeee"}, colors: [$scope.color.success, $scope.color.danger], tooltip: !0, tooltipOpts: {defaultTheme: !1}, xaxis: {mode: "time"}, yaxes: [
            {},
            {position: "right"}
        ]}, sampledata1 = [
            [1, 65],
            ...
            {label: " A", data: sampledata1, bars: {order: 0, fillColor: {colors: [
                {opacity: .3},
                {opacity: .3}
            ]}, show: !0, fill: 1, barWidth: .3, align: "center", horizontal: !1}},
            {data: sampledata2, curvedLines: {apply: !0}, lines: {show: !0, fill: !0, fillColor: {colors: [
                {opacity: .2},
                {opacity: .2}
            ]}}},
            {data: sampledata2, label: "D", points: {show: !0}}
        ], $scope.area1.options = {series: {curvedLines: {active: !0}, points: {lineWidth: 2, fill: !0, fillColor: "#ffffff", symbol: "circle", radius: 4}}, grid: {hoverable: !0, clickable: !0, tickColor: "#f9f9f9", borderWidth: 1, borderColor: "#eeeeee"}, tooltip: !0, tooltipOpts: {defaultTheme: !1}, colors: [$scope.color.gray, $scope.color.primary, $scope.color.primary]}, barChart = {}, barChart.data1 = [
            [2008, 20],
            [2009, 10],
            [2010, 5],
            [2011, 5],
        ...
        ], $scope.barChart.options = {series: {stack: !0, bars: {show: !0, fill: 1, barWidth: .3, align: "center", horizontal: !1, order: 1}}, grid: {hoverable: !0, borderWidth: 1, borderColor: "#eeeeee"}, tooltip: !0, tooltipOpts: {defaultTheme: !1}, colors: [$scope.color.success, $scope.color.info, $scope.color.warning, $scope.color.danger]}, $scope.barChart1 = {}, $scope.barChart1.data = [
            {label: "Value A", data: barChart.data1, bars: {order: 0}},
            {label: "Value B", data: barChart.data2, bars: {order: 1}},
            {label: "Value C", data: barChart.data3, bars: {order: 2}}
        ], $scope.barChart1.options = {series: {stack: !0, bars: {show: !0, fill: 1, barWidth: .2, align: "center", horizontal: !1}}, grid: {hoverable: !0, borderWidth: 1, borderColor: "#eeeeee"}, tooltip: !0, tooltipOpts: {defaultTheme: !1}, colors: [$scope.color.success, $scope.color.info, $scope.color.warning, $scope.color.danger]}, $scope.barChart3 = {}, $scope.barChart3.data = [
            {label: " A", data: [
                [40, 1],
                [59, 2],
                [90, 3],
            ...
            {label: " B", data: [
                ...
                [19, 4],
                [45, 5]
            ], bars: {order: 1, fillColor: {colors: [
                {opacity: .3},
                {opacity: .3}
            ]}}}
        ], $scope.barChart3.options = {series: {stack: !0, bars: {show: !0, fill: 1, barWidth: .35, align: "center", horizontal: !0}}, grid: {show: !0, aboveData: !1, color: "#eaeaea", hoverable: !0, borderWidth: 1, borderColor: "#eaeaea"}, tooltip: !0, tooltipOpts: {defaultTheme: !1}, colors: [$scope.color.gray, $scope.color.primary, $scope.color.info, $scope.color.danger]}, barChartH = {}, barChartH.data1 = [
            [85, 10],
            [50, 20],
            [55, 30]
        ], barChartH.data2 = [
            ...
            {label: "Value A", data: barChartH.data1, bars: {order: 1}},
            {label: "Value B", data: barChartH.data2, bars: {order: 2}},
            {label: "Value C", data: barChartH.data3, bars: {order: 3}}
        ], $scope.barChart2.options = {series: {stack: !0, bars: {show: !0, fill: 1, barWidth: 1, align: "center", horizontal: !0}}, grid: {hoverable: !0, borderWidth: 1, borderColor: "#eeeeee"}, tooltip: !0, tooltipOpts: {defaultTheme: !1}, colors: [$scope.color.success, $scope.color.info, $scope.color.warning, $scope.color.danger]}, $scope.pieChart = {}, $scope.pieChart.data = [
            {label: "Download Sales", data: 12},
            {label: "In-Store Sales", data: 30},
            {label: "Mail-Order Sales", data: 20},
            {label: "Online Sales", data: 19}
        ], $scope.pieChart.options = {series: {pie: {show: !0}}, legend: {show: !0}, grid: {hoverable: !0, clickable: !0}, colors: [$scope.color.primary, $scope.color.success, $scope.color.info, $scope.color.warning, $scope.color.danger], tooltip: !0, tooltipOpts: {content: "%p.0%, %s", defaultTheme: !1}}, $scope.donutChart = {}, $scope.donutChart.data = [
            {label: "Download Sales", data: 12},
            {label: "In-Store Sales", data: 30},
            {label: "Mail-Order Sales", data: 20},
            {label: "Online Sales", data: 19}
        ], $scope.donutChart.options = {series: {pie: {show: !0, innerRadius: .5}}, legend: {show: !0}, grid: {hoverable: !0, clickable: !0}, colors: [$scope.color.primary, $scope.color.success, $scope.color.info, $scope.color.warning, $scope.color.danger], tooltip: !0, tooltipOpts: {content: "%p.0%, %s", defaultTheme: !1}}, $scope.donutChart2 = {}, $scope.donutChart2.data = [
            {label: "Download Sales", data: 12},
            {label: "In-Store Sales", data: 30},
            {label: "Mail-Order Sales", data: 20},
            {label: "Online Sales", data: 19},
            {label: "Direct Sales", data: 15}
        ], $scope.donutChart2.options = {series: {pie: {show: !0, innerRadius: .45}}, legend: {show: !1}, grid: {hoverable: !0, clickable: !0}, colors: ["#1BB7A0", "#39B5B9", "#52A3BB", "#619CC4", "#6D90C5"], tooltip: !0, tooltipOpts: {content: "%p.0%, %s", defaultTheme: !1}}
    ...
    angular.module("app.ui.map", []).directive("uiJvectormap", [function () {
        ...
        return marker_data = [
            ...
            {latLng: [39.9, 116.4], name: "Beijing"},
            ...
            {latLng: [51.5, -.12], name: "London"},
            {latLng: [48.85, 2.35], name: "Paris"},
            {latLng: [52.52, 13.4], name: "Berlin"},
            {latLng: [-26.2, 28.04], name: "Johannesburg"},
    ...
    angular.module("app.ui.ctrls", []).controller("LoaderCtrl", ["$scope", "cfpLoadingBar", function ($scope, cfpLoadingBar) {
        ...
        ], $scope.items = ["Item 1", "Item 2", "Item 3"], $scope.status = {isFirstOpen: !0, isFirstOpen1: !0}, $scope.addItem = function () {
            var newItemNo;
    ...
    "use strict";
    //bhupendra
    angular.module("app", ["ui.boot", "ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart",
        "ui.tree", "ngMap", "ngTagsInput", "angular-loading-bar", "app.controllers",
        "app.directives", "app.localization", "app.nav", "app.ui.ctrls", "app.ui.directives",
        "app.ui.services", "app.ui.map", "app.form.validation", "app.ui.form.ctrls",
        "app.ui.form.directives", "app.tables", "app.task", "app.chart.ctrls",
        "app.chart.directives", "app.page.ctrls", "mainApp"])
        .value("httpInfo", {
            get: "POST",
            save: "POST",
            update: "PUT",
        ...
        var routes, setRoutes;
            return routes = ["organization/list", "organization/create",
                "ledger/list", "ledger/create",
                "group/list", "group/create",
                "company/create", "company/list",
                "user/create", "user/list",
                "role/create", "role/list",
                "userRole/create", "userRole/list",
                "voucherType/create", "voucherType/list",
                "voucher/create", "voucher/list",
                "reports/ledgerReport",
                "reports/groupVouchers",
                "reports/groupSummary",
                "reports/journalRegister",
                "reports/purchaseRegister",
                "reports/salesRegister",
                "reports/groupOutstanding",
                "reports/ledgerOutstanding",
                "reports/payablesOutstanding",
                "reports/receivablesOutstanding",
                "reports/statisticsReport",
                "reports/listOfAccountsReport",
                "reports/cashBankSummary",
                "reports/balanceSheet",
                "reports/dayBook",
                "reports/profitAndLossAc",
                "reports/trailBalance",
                "split/page",
                "dashboard", "ui/typography", "ui/buttons", "ui/icons",
                "ui/grids", "ui/widgets", "ui/components",
                "ui/boxes", "ui/timeline", "ui/nested-lists",
                "ui/pricing-tables", "ui/maps", "tables/static",
                "tables/dynamic", "tables/responsive", "forms/elements",
                "forms/layouts", "forms/validation", "forms/wizard", "charts/charts",
                "charts/flot", "pages/404", "pages/500", "pages/blank",
                "pages/forgot-password", "pages/invoice", "pages/lock-screen",
                "pages/profile", "pages/invoice", "pages/signin", "pages/signup",
                "mail/compose", "mail/inbox", "mail/single", "tasks/tasks"], setRoutes = function (route) {
            var config, url;
            return url = "/" + route, config = {templateUrl: "../view/" + route + ".html"}, $routeProvider.when(url, config), $routeProvider
        }, routes.forEach(function (route) {
            return setRoutes(route)
        }), $routeProvider.when("/", {redirectTo: "/dashboard"})
                .when("/error", {templateUrl: "../view/error/error.html"})
                .when("/company/create/:id", {templateUrl: "../view/company/create.html"})
                .when("/role/create/:id", {templateUrl: "../view/role/create.html"})
                .when("/group/create/:id", {templateUrl: "../view/group/create.html"})
                .when("/organization/create/:id", {templateUrl: "../view/organization/create.html"})
                .when("/user/create/:id", {templateUrl: "../view/user/create.html"})
                .when("/userRole/create/:id", {templateUrl: "../view/userRole/create.html"})
                .when("/voucherType/create/:id", {templateUrl: "../view/voucherType/create.html"})
                .when("/voucher/create/:id", {templateUrl: "../view/voucher/create.html"})
                .when("/ledger/create/:id", {templateUrl: "../view/ledger/create.html"})
    ...
    "use strict";
    angular.module("app.controllers", []).controller("AppCtrl", ["$scope", "$rootScope", "$modal", "httpService", "$location", "httpInfo", "$log", function ($scope, $rootScope, $modal, httpService, $location, httpInfo, $log) {
        var $window;
        $rootScope.companyList = [];
        $rootScope.userPwd = "";
        $rootScope.company = "";
        //$scope.largeModal = true;
        //bhupendra mahajan
        //exceute every time when new page is requseted
        userStatus();
        showHideElement();
        companyList();
        company();
        ...
        function userStatus() {
            ...
            httpService.callURL(params).then(function (data) {
                //alert("navCtrl");
                debugger;
                $rootScope.userPwd = data;
                console.log("username & password found" + $rootScope.userPwd);
            }, function (error) {
        ...
        function showHideElement() {
            debugger;
            if ($rootScope.userPwd.isAdmin) {
                $rootScope.orgShow = true;
                return false;
            } else {
                $rootScope.orgShow = false;
            }
            if ($rootScope.userPwd.isClient) {
                $rootScope.isClientShow = true;
            } else {
                $rootScope.isClientShow = false;
            }
            if (!$rootScope.userPwd.isAdmin && !$rootScope.userPwd.isClient) {
                $rootScope.orgShow = false;
                $rootScope.isClientShow = false;
            }
            if ($rootScope.userPwd.useMultipleCompany) {
                $rootScope.useMultipleCompany = true
            } else {
                $rootScope.useMultipleCompany = false
            }
        }
        ...
        function companyList() {
            ...
            httpService.callURL(params).then(function (data) {
                ...
                console.log("companyList found" + $rootScope.companyList);
            }, function (error) {
                console.error("companyList not found");
            });
        }
        ...
        function company() {
            ...
            httpService.callURL(params).then(function (data) {
                ...
                console.log("company found" + $rootScope.company);
            }, function (error) {
        ...
        $rootScope.$on('$viewContentLoaded', function (event, next) {
            ...
            for (var i = 0; i < $rootScope.companyList.length; i++) {
                if ($rootScope.companyList[i].status) {
                    count++;
                }
            }
            if (count > 1) {
            ...
            httpService.callURL(params).then(function (data) {
                ...
                switch ($scope.session) {
                    ...
                    case "multiple":
                        var params = {
                            method: httpInfo.get,
                            url: "../login/findAllCompanyByOrgId",
                            data: {},
                            headers: {'Content-Type': httpInfo.urlEncoded}
                        };
                        if (!$rootScope.companyList.length) {
                            httpService.callURL(params).then(function (data) {
                                $rootScope.companyList = data;
                                console.log($scope.companyList);
                                $scope.openCompanyModal();
                            }, function (errors) {
                                console.error("multiple company not found");
                            });
                        }
                        ;
                        if (!$rootScope.userPwd) {
                ...
                $location.url("http://localhost:8083/yogiAccount");
            });           
        });       
        ...
        //ModalComapnyCtrl is next process after poopup open;
        $scope.openCompanyModal = function () {
            var modalInstance;
            modalInstance = $modal.open({
                keyboard: false, backdrop: false,
                templateUrl: "myModalContent.html", controller: "ModalComapnyCtrl", resolve: {
                    items: function () {
                        return $rootScope.companyList
                    }
                }
            }), modalInstance.result.then(function (selectedItem) {
                $scope.selected = selectedItem
        ...
        $scope.openAccountSettingModal = function () {
            debugger;
            var modalInstance;
            modalInstance = $modal.open({
                //keyboard: false, backdrop: true,
                templateUrl: "accountSettingModal.html", controller: "AccountSettingCtrl", resolve: {
                    items: function () {
                        return $rootScope.companyList
                    }
                }
        ...
        $scope.openStatutoryModal = function () {
            var modalInstance;
            modalInstance = $modal.open({
                //keyboard: false, backdrop: false,
                templateUrl: "statutoryModal.html", controller: "StatutorySettingCtrl", resolve: {
                    items: function () {
                        return $rootScope.companyList
                    }
                }
        ...
        $scope.openInterestModal = function (bool) {
            if (bool) {
                var modalInstance;
                modalInstance = $modal.open({
                    keyboard: false, backdrop: false,
                    templateUrl: "interestParameter.html", controller: "InterestParaCtrl", resolve: {
                        items: function () {
                            return $rootScope.companyList
                        }
                    }
        ...
        $scope.openMaintainBillModal = function (bool, opAmount) {
            if (bool && opAmount) {
                var modalInstance;
                modalInstance = $modal.open({
                    keyboard: false, backdrop: false,
                    templateUrl: "MaintainBillByBill.html", controller: "InterestParaCtrl", resolve: {
                        items: function () {
                            return $rootScope.companyList
                        }
                    }
        ...
        return $window = $(window), $scope.main = {
            ...
            {name: "Slide in from right", "class": "animate-slide-in-right"},
    ...
    }]).controller("ModalComapnyCtrl", ["$scope", "$rootScope", "$modalInstance", "items", "httpInfo", "httpService", "$location", function ($scope, $rootScope, $modalInstance, items, httpInfo, httpService, $location) {
        //alert("asdfsdfsf");
        ...
        $scope.items = items, $scope.selected = {item: $scope.items[0]},
            $scope.ok = function () {
                var params = {
                    ...
                    data: "list=" + angular.toJson($rootScope.companyList),
                    headers: {'Content-Type': httpInfo.urlEncoded}
                };

                httpService.callURL(params).then(function (data) {
                    $rootScope.company = data;
                    console.log("create a Session for multiple company successfully");
                }, function (errors) {
    ...
    }]).controller("NavCtrl", ["$scope", "taskStorage", "filterFilter", "$http", function ($scope, taskStorage, filterFilter, $http) {
        init();
        function init() {
            $scope.screenList = [];
            $http({
                method: 'POST',
                url: "../login/getScreenList",
                data: "",
