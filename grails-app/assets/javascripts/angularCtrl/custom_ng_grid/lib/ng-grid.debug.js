...
/// <reference path="../../lib/jquery-1.8.2.min" />
    ...
    angular.module('ngGrid').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('checkboxCellTemplate.html',
            "<div class=\"ngSelectionCell\"><input tabindex=\"-1\" class=\"ngSelectionCheckbox\" type=\"checkbox\" ng-checked=\"row.selected\" /><span class='lbl'></span></div>"
        );


        $templateCache.put('checkboxHeaderTemplate.html',
            "<input class=\"ngSelectionHeader\" type=\"checkbox\" ng-show=\"multiSelect\" ng-model=\"allSelected\" ng-change=\"toggleSelectAll(allSelected, true)\"/><span class='lbl'></span>' "
        );
        ...
        $templateCache.put('menuTemplate.html',
            ...
            "\n" +
            "                <label><input ng-disabled=\"col.pinned\" type=\"checkbox\" class=\"ngColListCheckbox\" ng-change=\"getAlert(col.displayName,col.field,col.visible,col.data)\" ng-model=\"col.visible\"/><span class=\'lbl\'>{{col.displayName}}</span></label>\r" +
            "\n" +
...
//    "\n" +
            "            </li>\r" +
            "\n" +
            "<li class=\"ngColListItem\">\r" +
            "\n" +
            "<button type='button' ng-click=\"save(columns)\">Save</button>\r" +
            "\n" +
            "            </li>\r" +
            "\n" +
            "        </ul>\r" +
