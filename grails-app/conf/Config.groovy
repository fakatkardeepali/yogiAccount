...
// log4j configuration
log4j.main = {
    // log4j configuration RestfulApiController_messageLog.
...
cors.expose.headers = 'content-type,application/json,X-hedtech-totalCount,X-hedtech-pageOffset,X-hedtech-pageMaxSize,X-hedtech-message,X-hedtech-Media-Type,X-Request-ID'
